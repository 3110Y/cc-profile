...
func (c *profileServiceClient) ChangePassword(ctx context.Context, in *ProfilePassword, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
	err := c.cc.Invoke(ctx, "/profileService.ProfileService/ChangePassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileServiceClient) GetByEmailOrPhone(ctx context.Context, in *ProfileEmailPhonePassword, opts ...grpc.CallOption) (*ProfileWithoutPassword, error) {
	out := new(ProfileWithoutPassword)
	err := c.cc.Invoke(ctx, "/profileService.ProfileService/GetByEmailOrPhone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProfileServiceServer) GetByEmailOrPhone(context.Context, *ProfileEmailPhonePassword) (*ProfileWithoutPassword, error) {
...
func _ProfileService_ChangePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/profileService.ProfileService/ChangePassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).ChangePassword(ctx, req.(*ProfilePassword))
	}
	return interceptor(ctx, in, info, handler)
}

func _ProfileService_GetByEmailOrPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProfileEmailPhonePassword)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServiceServer).GetByEmailOrPhone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/profileService.ProfileService/GetByEmailOrPhone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).GetByEmailOrPhone(ctx, req.(*ProfileEmailPhonePassword))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProfileService_GetByEmailOrPhone_Handler,
		},
	},
